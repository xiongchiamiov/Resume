...
\sectionline
    ...
    Owner of and interviewer trainer for SRE interview module.  Active member of hiring committee, making leveling and hiring decisions for all of engineering.\\
    \textbf{Manager, Site Reliability Engineering} \hfill \textbf{March 2020 -- May 2021}\\
    Provide a first line of time defense for the team.  Work with other engineering and product leads to plan and prioritize projects.\\
    ...
    % XYZ Textbooks
    \text{\listing XYZ Textbooks} \vspace{2mm}\\\vspace{1mm}%
    \textbf{Web Programmer / Sysadmin} \hfill \textbf{June 2008 -- March 2011}

    % Cal Poly
    \text{\listing Cal Poly} \vspace{2mm}\\\vspace{1mm}%

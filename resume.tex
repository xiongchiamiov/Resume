...
\sectionline
    ...
    % Winnie
    \textbf{\listing Winnie} \hfill {\fontfamily{ptm}\selectfont\texttildelow}12 engineers
    \vspace{2mm}\\\vspace{1mm}%
    \textsl{Staff Site Reliability Engineer} \hfill \textbf{February 2022 -- current}\\
    
    % WePay
    \textbf{\listing WePay (acquired by JPMorgan Chase)} \hfill {\fontfamily{ptm}\selectfont\texttildelow}80→200 engineers
    \vspace{2mm}\\\vspace{1mm}%
    ...
    % Zoox
    \textbf{\listing Zoox} \hfill {\fontfamily{ptm}\selectfont\texttildelow}80 engineers
    \vspace{2mm}\\\vspace{1mm}%
    ...
    % reddit
    \textbf{\listing reddit} \hfill {\fontfamily{ptm}\selectfont\texttildelow}20 engineers
    \vspace{2mm}\\\vspace{1mm}%
    ...
    % iFixit
    \textbf{\listing iFixit} \hfill {\fontfamily{ptm}\selectfont\texttildelow}12 engineers
    \vspace{2mm}\\\vspace{1mm}%
